...
export default function PipeWeightCalculatorPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 text-slate-900">
      ...
      <header className="border-b border-slate-800 bg-[#0e2a47] text-white"><div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6"><Link className="font-bold tracking-wide" href="/">CANHOPE STEEL</Link><Link className="text-sm font-semibold text-blue-100 hover:text-white" href="/">Full Steel Calculator &amp; RFQ Builder</Link></div></header>
      <section className="mx-auto max-w-6xl px-4 pb-8 pt-10 sm:px-6"><p className="text-sm font-semibold uppercase tracking-wider text-[#0e5f9f]">Free online steel tool</p><h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl">Steel Pipe Weight Calculator</h1><p className="mt-4 max-w-3xl text-base leading-7 text-slate-600">Calculate theoretical steel pipe weight per meter, per piece and for your full order. Enter the outside diameter, wall thickness, length and quantity, or choose an existing pipe specification.</p><div className="mt-7"><PipeWeightCalculator /></div></section>
