...
function getDraftSecret() {
	return "cca6b5a0-7276-4ae0-8989-eaece6579e25";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bda18384-fd30-40cb-ae81-12f8f1ba5db9";
	}
};
...
}, "fa2fcf37606f", "ForbiddenBoundary");
...
}, "fa2fcf37606f", "UnauthorizedBoundary");
/**
...
}, "3c1a6b559290", "LayoutSegmentProvider");
/**
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bda18384-fd30-40cb-ae81-12f8f1ba5db9") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bda18384-fd30-40cb-ae81-12f8f1ba5db9",
		rootBoundaryId
	});
}
/**
...
seoConfig.siteName, seoConfig.siteUrl, seoConfig.defaultLanguage, seoConfig.brandName, seoConfig.mainWebsiteUrl, `${seoConfig.mainWebsiteUrl.replace(/\/$/, "")}${seoConfig.logoPath}`, seoConfig.title, seoConfig.siteUrl, seoConfig.description, seoConfig.defaultLanguage, seoConfig.brandName, seoConfig.mainWebsiteUrl;
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("ul", {
					...
					].map((point) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					...
					className: "mt-2 space-y-2 text-sm",
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
						className: "block hover:text-[#0e5f9f]",
						href: "https://canhopesteel.com/",
						target: "_blank",
						rel: "noopener noreferrer",
				...
				/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: contactConfig.email })
					]
				})] })
			]
...
}, "3ca4db5c3a22", "SiteHeader");
var PipeWeightCalculator = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'PipeWeightCalculator' is called on server");
}, "d53a144fc609", "PipeWeightCalculator");
...
Object.entries(channelSteelRawData).map(([nominalSize, options]) => ({
	id: nominalSize,
	nominalSize,
	referenceLengthM: 6,
...
].flatMap((product) => product.records.map((record) => ({
	...record,
...
Object.entries(iBeamRawData).map(([size, options]) => ({
	id: size,
	size,
	referenceLengthM: 6,
	weightOptions: options.map(([referenceWeightKgPerPiece, piecesPerBundle]) => ({
...
var page_exports = /* @__PURE__ */ __exportAll({
	default: () => PipeWeightCalculatorPage,
	dynamic: () => dynamic,
	metadata: () => metadata
});
var dynamic = "force-static";
var url = seoConfig.pipeWeightCalculatorUrl;
var title = "Pipe Weight Calculator – kg/m & Total Weight | CANHOPE";
var description = "Calculate steel pipe weight per meter, per piece and total order weight using outside diameter, wall thickness, length and quantity. Includes a free 40HQ weight estimate.";
var metadata = {
	title,
	description,
...
var exampleKgPerMeter = calculateRoundSteelPipeKgPerMeter(48, 2);
var examplePieceWeight = exampleKgPerMeter * 6;
var exampleTotalWeight = examplePieceWeight * 100;
function PipeWeightCalculatorPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			...
			].map((item) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", {
				type: "application/ld+json",
				dangerouslySetInnerHTML: { __html: JSON.stringify(item) }
			}, item["@type"])),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(SiteHeader, {}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
				className: "mx-auto max-w-6xl px-4 pb-8 pt-10 sm:px-6",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "text-sm font-semibold uppercase tracking-wider text-[#0e5f9f]",
						children: "Free online steel tool"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", {
						...
						children: "Steel Pipe Weight Calculator"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
						className: "mt-4 max-w-3xl text-base leading-7 text-slate-600",
						children: "Calculate theoretical steel pipe weight per meter, per piece and for your full order. Enter the outside diameter, wall thickness, length and quantity, or choose an existing pipe specification."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
						className: "mt-7",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PipeWeightCalculator, {})
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
				className: "mx-auto max-w-6xl space-y-10 px-4 pb-14 sm:px-6",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ContentSection, {
						title: "How to Calculate Steel Pipe Weight",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"For custom black welded steel pipe, the calculator uses the project's existing theoretical formula: ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("code", {
								className: "break-all rounded bg-slate-100 px-1 py-0.5",
								children: "kg/m = 0.02466 × wall thickness (mm) × (outside diameter (mm) − wall thickness (mm))"
							}),
							". Weight per piece is kg/m multiplied by length in meters, and total weight is weight per piece multiplied by quantity. Standard product selections continue to prioritize their confirmed reference weights."
						] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ContentSection, {
						title: "Calculation Example",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("p", { children: [
							"For a black welded steel pipe with an outside diameter of 48 mm, wall thickness of 2.0 mm, length of 6 m and quantity of 100 pieces, the existing production calculation returns ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: [formatNumber(exampleKgPerMeter, 5, "en"), " kg/m"] }),
							", ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: [formatNumber(examplePieceWeight, 5, "en"), " kg per piece"] }),
							", and ",
							/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("strong", { children: [formatNumber(exampleTotalWeight, 2, "en"), " kg total"] }),
							"."
						] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(ContentSection, {
						title: "Theoretical Weight vs Actual Weight",
						children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "The calculator provides theoretical weight based on nominal dimensions. Actual pipe weight may vary because of wall thickness tolerance, outside diameter tolerance, steel density, zinc coating, manufacturing tolerance and measured pipe length." }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
							className: "mt-3",
							children: "For purchasing and shipment planning, confirm the final unit weight, mill tolerance and packing details with the supplier."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ContentSection, {
						title: "Related Products and Resources",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("ul", {
							className: "space-y-3 font-semibold text-[#0e5f9f]",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "https://canhopesteel.com/products/pipes/galvanized-pipe/",
									children: "View Galvanized Steel Pipe Specifications"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "https://canhopesteel.com/fire-sprinkler-pipe/",
									children: "Read the Fire Sprinkler Pipe Guide"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "https://canhopesteel.com/galvanized-pipe-size-chart/",
									children: "View the Galvanized Pipe Size and Weight Chart"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("a", {
									href: "https://canhopesteel.com/products/",
									children: "Browse Steel and Fire Protection Products"
								}) }),
								/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
									href: calculatorPaths.home,
									children: "Open the Full Steel Calculator & RFQ Builder"
								}) })
							]
						})
					}),
					/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(ContentSection, {
						title: "Pipe Weight Calculator FAQ",
						children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", {
							className: "space-y-5",
							children: faqs.map(([question, answer]) => /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h3", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(BrandTrustSection, {}),
...
function ContentSection({ title, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("section", {
		className: "rounded-xl border border-slate-200 bg-white p-5 text-base leading-7 text-slate-600 shadow-sm sm:p-7",
...
var routes = [{
	...
	ids: {
		"route": "route:/pipe-weight-calculator",
		"page": "page:/pipe-weight-calculator",
		"routeHandler": null,
		"rootBoundary": "root-boundary:/",
		"layouts": ["layout:/"],
		"templates": [],
	...
	pattern: "/pipe-weight-calculator",
	patternParts: ["pipe-weight-calculator"],
	isDynamic: false,
	params: [],
	rootParamNames: [],
	page: page_exports,
	routeHandler: null,
	layouts: [layout_exports],
	routeSegments: ["pipe-weight-calculator"],
	templateTreePositions: [],
	layoutTreePositions: [0],
	templates: [],
	errors: [null],
