...
function getDraftSecret() {
	return "54e8d052-9610-43d9-acf3-bc0e51b7dee7";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "48dd76ee-fbe4-4f84-956a-c08aaf8172eb";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "48dd76ee-fbe4-4f84-956a-c08aaf8172eb") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "48dd76ee-fbe4-4f84-956a-c08aaf8172eb",
		rootBoundaryId
	});
}
/**
