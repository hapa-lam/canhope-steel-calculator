...
function getDraftSecret() {
	return "a9ef9ea0-396b-48f3-8043-d15cfba01f62";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d0c5c2be-3aa7-4179-8065-79f5c9626e0b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d0c5c2be-3aa7-4179-8065-79f5c9626e0b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d0c5c2be-3aa7-4179-8065-79f5c9626e0b",
		rootBoundaryId
	});
}
/**
...
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => page_default });
...
seoConfig.siteName, seoConfig.siteUrl, seoConfig.defaultLanguage, seoConfig.brandName, seoConfig.mainWebsiteUrl, `${seoConfig.siteUrl.replace(/\/$/, "")}${seoConfig.logoPath}`, seoConfig.title, seoConfig.siteUrl, seoConfig.description, seoConfig.defaultLanguage, seoConfig.brandName, seoConfig.mainWebsiteUrl;
...
var url = "https://calculator.canhopesteel.com/pipe-weight-calculator/";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			[
				...
				},
				{
					...
					itemListElement: [{
						...
						position: 1,
						name: "Home",
						item: "https://calculator.canhopesteel.com/"
					}, {
						"@type": "ListItem",
						position: 2,
						name: "Pipe Weight Calculator",
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("header", {
				className: "border-b border-slate-800 bg-[#0e2a47] text-white",
				children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(link_default, {
						...
						href: "/",
						children: "Full Steel Calculator & RFQ Builder"
					})]
				})
			}),
