export const en = {
  ...
  guide: {
    title: "How to Use",
    steps: [
      "Select the steel product or fitting you need.",
      "Choose the specification and enter the quantity.",
      "Review the estimated weight and prepare your RFQ.",
    ],
  },
  materialList: {
  ...
  summary: {
    ...
    theoreticalWeight: "Estimated Total Weight",
    missingWeight: "Missing Weight",
    containerEstimate: "40HQ Weight Capacity Check",
    estimated: "Estimated",
    remainingCapacity: "Unused Weight Capacity",
    capacityReached: "Configured Capacity Reached",
    byWeightOnly: "By weight only",
    knownWeightsOnly: "Known weights only",
    fitsWithin: "fits within",
    noLoadEntered: "No load entered",
    pendingWeights: "{count} rows are pending weight confirmation",
  ...
  inquiry: {
    ...
    projectQuoteContact: "Continue to Project Enquiry",
    copyRfq: "Copy RFQ",
