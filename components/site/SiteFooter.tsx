  ...
  return (
    <footer className="border-t border-slate-200 bg-white text-slate-600">
      <div className="mx-auto grid max-w-[1500px] gap-7 px-4 py-9 sm:grid-cols-2 sm:px-6 lg:grid-cols-4">
        ...
        <div><p className="font-bold text-slate-950">Tools</p><div className="mt-2 space-y-2 text-sm"><Link className="block hover:text-[#0e5f9f]" href="/">Full Steel Calculator</Link><Link className="block hover:text-[#0e5f9f]" href="/pipe-weight-calculator/">Pipe Weight Calculator</Link></div></div>
